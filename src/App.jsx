...
// LOGOS EMBEBIDOS
// ═══════════════════════════════════════════════════════════════════
const LOGO_GOLFB = "data:image/jpeg;base64,";
...
const LOGO_GCR_PDF = "data:image/jpeg;base64,";
const LOGO_PGA = "data:image/jpeg;base64,";
    ...
    <div style={{minHeight:"100vh",background:`linear-gradient(160deg,${G.fairway} 0%,#0f3518 100%)`,
      ...
      <div style={{background:G.white,borderRadius:24,padding:"32px 28px",width:"100%",
        ...
        <div style={{display:"flex",justifyContent:"center",alignItems:"center",gap:12,marginBottom:10}}>
          <img src={LOGO_GCR} alt="Golf Ciudad Real" style={{height:48,objectFit:"contain"}}/>
          <img src={LOGO_PGA} alt="PGA España" style={{height:44,objectFit:"contain"}}/>
          <img src={LOGO_ENG} alt="Escuela Nacional" style={{height:44,objectFit:"contain"}}/>
        </div>

        <div style={{fontWeight:700,fontSize:15,color:G.fairway,marginBottom:20}}>
  ...
  return <div style={{maxWidth:680,margin:"0 auto"}}>
    ...
    {secs.includes("portada")&&<div style={{background:`linear-gradient(160deg,${G.fairway},#0f3518)`,
      ...
      <div style={{display:"flex",justifyContent:"center",gap:16,marginBottom:16,alignItems:"center"}}>
        <img src={LOGO_GCR} alt="GCR" style={{height:56,objectFit:"contain",background:"white",borderRadius:8,padding:"4px 6px"}}/>
        <img src={LOGO_PGA} alt="PGA" style={{height:52,objectFit:"contain",background:"white",borderRadius:8,padding:"4px 6px"}}/>
      </div>
