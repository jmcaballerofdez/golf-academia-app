...
async function generarPDFClase(clase, alumnoNombre){
  ...
  // Logos
  try { doc.addImage(LOGO_GCR, "JPEG", 8, 3, 22, 22); } catch(e){}
...
async function generarPDFInforme(rpt, alumnoNombre){
  ...
  // Logos en cabecera
  try { doc.addImage(LOGO_GCR, "JPEG", 8, 4, 22, 22); } catch(e){}
...
// LOGOS EMBEBIDOS
// ═══════════════════════════════════════════════════════════════════
const LOGO_GCR = "data:image/jpeg;base64,";
