...
// LOGOS EMBEBIDOS
// ═══════════════════════════════════════════════════════════════════
const LOGO_GOLFB = "data:image/jpeg;base64,";

const LOGO_GCR = "data:image/png;base64,";
const LOGO_GCR_PDF = "data:image/jpeg;base64,";
const LOGO_PGA = "data:image/jpeg;base64,";
const LOGO_ENG = "data:image/jpeg;base64,";
    ...
    <div style={{minHeight:"100vh",background:`linear-gradient(160deg,${G.fairway} 0%,#0f3518 100%)`,
      ...
      <div style={{background:G.white,borderRadius:24,padding:"32px 28px",width:"100%",
        ...
        <div style={{display:"flex",justifyContent:"center",alignItems:"center",gap:10,marginBottom:14}}>
          ...
          <img src={LOGO_PGA} alt="PGA España" style={{height:42,objectFit:"contain"}}/>
          <img src={LOGO_ENG} alt="Escuela Nacional" style={{height:40,objectFit:"contain"}}/>
        </div>

        <div style={{fontWeight:800,fontSize:17,color:G.fairway,marginBottom:2}}>
          Plataforma Gestión Escuela de Golf
        </div>
        <div style={{fontSize:11,color:"#aaa",marginBottom:24}}>Golf Ciudad Real C.D.</div>
      ...
      <div style={{maxWidth:920,margin:"0 auto"}}>
        <div style={{padding:"14px 0 0",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            ...
            {/* Logos secundarios */}
            <img src={LOGO_GCR} alt="Golf Ciudad Real" style={{height:38,objectFit:"contain"}}/>
